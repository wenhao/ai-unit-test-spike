...
public class WorkService {
    public SalaryRequest get(final Long userId) {
        return ImmutableMap.<Long, SalaryRequest>builder()
                .put(801L, getSalaryRequest(OFFICE_ASSISTANT, 3000, 0, 3, 22, 0))
                .put(802L, getSalaryRequest(OFFICE_ASSISTANT, 3000, 0, 11, 20, 0))
                .put(803L, getSalaryRequest(FACTORY_WORKER, 2400, 13, 1, 22, 0))
                .put(804L, getSalaryRequest(FACTORY_WORKER, 2400, 6, 7, 19, 0))
                .put(805L, getSalaryRequest(QUALITY_CONTROL, 3600, 0, 5, 22, 0))
                .put(806L, getSalaryRequest(SALES, 3000, 0, 1, 22, 7))
                .put(807L, getSalaryRequest(SALES, 3000, 0, 4, 22, 38))
                .put(808L, getSalaryRequest(SALES, 3000, 0, 12, 21, 54))
                .build()
                .get(userId);
    }
